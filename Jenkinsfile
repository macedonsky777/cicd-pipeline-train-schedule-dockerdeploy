            ...
            steps {
                ...
                sshagent(credentials: ['webserver_login']) {          
                    script {
                        ...
                        sh "ssh -t -t -o StrictHostKeyChecking=no $prod_ip "docker run --restart always --name train-schedule -p 8080:8080 -d 777777777777777/train-schedule:${env.BUILD_NUMBER}""
                    }
                }
            }
        }
